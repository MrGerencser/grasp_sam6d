...
ply = o3d.io.read_triangle_mesh('/home/chris/franka_ros2_ws/src/sam6d_wrapper/Data/models/master_chef_can/master_chef_can_mm.ply')
...
# visualize the mesh
o3d.visualization.draw_geometries([ply, coord])
